...
export default function firstyr() {
    return(
      ...
      <ul>
        <li className="border border-none rounded-[10px]  my-4 px-40 py-3 cursor-pointer hover:bg-[#f0f1f0] transition 0.4s ease">
          <a href="https://drive.google.com/drive/u/1/folders/1EI4QwjCNXIeFYluHdpGUqL6PELoNCLsH" target="_blank">EEE</a></li>
        <li className="border border-none rounded-[10px]  mb-3 px-40 py-3 cursor-pointer hover:bg-[#f0f1f0] transition 0.4s ease">
        ...
        <li className="border border-none rounded-[10px]  mb-7 px-40 py-3 cursor-pointer hover:bg-[#f0f1f0] transition 0.4s ease">
