...
export default function firstyr() {
    return(
      ...
      <ul className="w-full">
        <a href="https://drive.google.com/drive/u/1/folders/1-0M11_3_NPB8PrLwcOznxYl7hbXhDISL" target="_blank"><li className="border border-[#8c8c8c] rounded-[10px]  my-4 lg:px-40 py-3 cursor-pointer hover:bg-[#d1d1d1] transition 0.4s ease">
          Multivariable Calculus</li></a>
