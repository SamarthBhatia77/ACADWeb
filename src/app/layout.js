    ...
    <html lang="en">
      <body className="min-h-screen flex flex-col">
        <div className="fixed top-0 left-0 w-full z-50 backdrop-blur-md flex align-centers items-center justify-between mb-10">
            <header className="backdrop-blur-md text-black text-[2em] font-mono font-bold p-4">ACADWeb: Your go-to Study Place</header>
        ...
        <footer className="font-sans text-black mt-21 bg-white">
          <p className="font-mono text-2xl font-bold ml-6 mt-5 mb-5">ACADWeb</p>
          <p className="ml-6 py-2 font-mono text-[#7D7D7D]">Tap in into the shared rescources with ease and score a good CGPA with ACADWeb by your side</p>
